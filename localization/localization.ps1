...
function sfe-localization-addCultures {
    param(
...
function sfe-localization-removeCultures {
    param(
        [string[]]$frontendCultures,
        [string[]]$backendCultures,
        [switch]$all
...
function sfe-localization-setDefaultCulture {
    param(
        $frontendCulture,
        $backendCulture
    )
...
function sfe-localization-removeSiteCultures {
    param (
        [string[]]$cultures,
        [int]$siteIndex = 0
    )
...
function sfe-localization-setSiteDefaultCulture {
    param (
        [string]$culture,
        [int]$siteIndex = 0
    )
